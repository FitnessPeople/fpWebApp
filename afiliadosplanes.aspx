<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="afiliadosplanes.aspx.cs" Inherits="fpWebApp.afiliadosplanes" %>
...
<head>
    ...
    <title>Fitness People | Afiliados con plan</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fas fa-user-tag text-success m-r-sm"></i>Afiliados con plan</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Afiliados</li>
                        <li class="active"><strong>Afiliados con plan</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                        ...
                        <div class="row" id="divContenido" runat="server">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Lista de Afiliados con Plan Activo</h5>
