<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="biopersonas.aspx.cs" Inherits="fpWebApp.biopersonas" %>
...
<head>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#biopersonas");
                                    ...
                                    <table class="footable table table-striped" data-paging-size="10" 
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-breakpoints="xs sm md">Last Name</th>
                                                <th data-breakpoints="xs sm md">Pin</th>
                                                <th data-breakpoints="xs sm md">Birthday</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <asp:Repeater ID="rpPersonas" runat="server">
                                                <ItemTemplate>
                                                    <tr>
                                                        <td><%# Eval("id") %></td>
                                                        <td><%# Eval("name") %></td>
