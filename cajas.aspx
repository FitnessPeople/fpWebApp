<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cajas.aspx.cs" Inherits="fpWebApp.cajas" %>
                                    ...
                                    <div class="ibox-content">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <a href="cajas" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="row" style="font-size: 12px;" runat="server" id="divBotonesLista">
                                            ...
                                            <div class="col-lg-2 form-horizontal">
                                                <a class="btn btn-info pull-right dim m-l-md" style="font-size: 12px;" 
                                                    ...
                                                    href="imprimircajas" title="Imprimir"><i class="fa fa-print"></i> IMPRIMIR</a>
                                            </div>
                                        </div>
                                        ...
                                        <table class="footable table" data-page-size="10" data-filter="#filter" data-filter-minimum="3">
                                            <thead>
                                                <tr>
                                                    <th width="80%" data-sort-initial="true">Caja de Compensación</th>
