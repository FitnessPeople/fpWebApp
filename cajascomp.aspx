<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cajascomp.aspx.cs" Inherits="fpWebApp.cajascomp" %>
...
<head>
    ...
    <title>Fitness People | Cajas de Compensación</title>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-piggy-bank modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar cajas de compensación</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar las cajas de compensación de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-piggy-bank" style="color: #0D6EFD;"></i> <b>Caja de Compensación</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-piggy-bank text-success m-r-sm"></i>Cajas de Compensación</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Seguridad Social</li>
                        <li class="active"><strong>Cajas de Compensación</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                    ...
                    <form role="form" id="form" runat="server">
                        <div class="row" id="divContenido" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Nombre de la Caja de Compensación:</label>
                                                    <asp:TextBox ID="txbCajaComp" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvCajaComp" runat="server" ErrorMessage="* Campo requerido" 
                                                    ControlToValidate="txbCajaComp" ValidationGroup="agregar" 
                                                    CssClass="font-bold text-danger"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="form-group">
                                                    <a href="cajascomp" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                            ...
                            <div class="col-lg-8">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Lista de Cajas de Compensación</h5>
                                        <div class="ibox-tools">
                                            <a class="collapse-link">
                                                <i class="fa fa-chevron-up"></i>
                                            </a>
