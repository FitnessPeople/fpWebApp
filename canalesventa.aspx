        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-list-ul modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar los canales de ventas</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los canales de ventas de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-list-ul" style="color: #0D6EFD;"></i> <b>Canal de Ventas</b>
                    <br />
                        <br />
