<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cancelardebito.aspx.cs" Inherits="fpWebApp.cancelardebito" %>
...
<head>
    ...
    <title>Fitness People | Cancelar débito automático</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-hand-holding-usd text-success m-r-sm"></i>Cancelar débito automático</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Reportes</li>
                        <li class="active"><strong>Cancelar débito automático</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Cancelar el cobro de débito automático</h5>
