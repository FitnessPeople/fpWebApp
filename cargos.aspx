...
<head>
    ...
    <title>Fitness People | Cargos Empleados</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa-solid fa-address-card text-success m-r-sm"></i>Cargos empleado</h2>
                    <ol class="breadcrumb">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txbNombreCargo" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvNombreCargo" runat="server" ErrorMessage="* Campo requerido"
                                                        ControlToValidate="txbNombreCargo" ValidationGroup="agregar"
                                                        CssClass="font-bold text-danger"></asp:RequiredFieldValidator>

                                                </div>
                                                <div class="form-group">
                                                    <a href="cargos" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <table class="footable table table-striped" data-paging-size="10"
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpCargos" runat="server" OnItemDataBound = "rpCargos_ItemDataBound" >
                                                    <ItemTemplate>
