<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="categoriastienda.aspx.cs" Inherits="fpWebApp.categoriastienda" %>
...
<head>
    ...
    <title>Fitness People | Categorías tienda</title>
    ...
    <script>
        function changeClass() {
            ...
            var element1 = document.querySelector("#categoriastienda");
            if (element1) {
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Guía para administrar Categorías</h4>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-cart-shopping text-success m-r-sm"></i>Categorías tienda</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Página Web</li>
                        <li class="active"><strong>Categorías</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txbCategoria" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvCategoria" runat="server" ErrorMessage="* Campo requerido" 
                                                        ControlToValidate="txbCategoria" ValidationGroup="agregar" 
                                                        CssClass="font-bold text-danger"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="form-group">
                                                    <a href="categoriastienda" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <table class="footable table table-striped" data-paging-size="10"
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpCategoria" runat="server" OnItemDataBound="rpCategoria_ItemDataBound">
                                                    <ItemTemplate>
