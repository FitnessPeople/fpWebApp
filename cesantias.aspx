<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cesantias.aspx.cs" Inherits="fpWebApp.cesantias" %>
...
<head>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#cesantias");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-hand-holding-dollar modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar los fondos de cesantías</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los fondos de cesantías de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-hand-holding-dollar" style="color: #0D6EFD;"></i> <b>Fondo de Cesantías</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-hand-holding-dollar text-success m-r-sm"></i>Fondos de Cesantías</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Seguridad Social</li>
                        <li class="active"><strong>Fondos de Cesantías</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
