<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ciudades.aspx.cs" Inherits="fpWebApp.ciudades" %>
...
<head>
    ...
    <title>Fitness People | Ciudades</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#ciudades");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Guía para visualizar ciudades</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar las ciudades de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    <p>
                        <b>Paso 1: Crea uno nuevo</b><br />
                        Usa el formulario que está a la <b>izquierda</b> para: 
                        Seleccionar el departamento al que pertenece la ciudad.<br />
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-city" style="color: #0D6EFD;"></i> <b>Ciudades</b> o
                        <i class="fa-solid fa-building-wheat" style="color: #0D6EFD;"></i> <b>Departamentos</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-city text-success m-r-sm"></i>Ciudades</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Configuración</li>
                        <li class="active"><strong>Ciudades</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
