...
int valor, string observaciones, string estado)
        ...
        public string ActualizarProcesoFechasNacimiento(int idAfiliado,  string fechaNacAfiliado, int idGenero)
        {
            string respuesta = string.Empty;
            try
            {
        ...
        public DataTable ConsultarUsuarioPorId(int idUsuario)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_USUARIO_POR_ID", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_usuario", idUsuario);
