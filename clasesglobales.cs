...
namespace fpWebApp
{
    public class clasesglobales
    {
        ...
        public DataTable ConsultarGymPassAgendaYGymPassPorId(int idGymPass)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_GYM_PASS_AGENDA_Y_GYM_PASS_POR_ID", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_gym_pass", idGymPass);
        ...
        public DataTable ConsultarGymPassAgendaYGymPassPorDocumento(string nroDocumento)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_GYM_PASS_AGENDA_Y_GYM_PASS_POR_DOCUMENTO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_doc_gym_pass", nroDocumento);
        ...
        public DataTable ConsultarGymPassAgendaYGymPassPorSede(int idSede)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_GYM_PASS_AGENDA_Y_GYM_PASS_POR_SEDE", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_sede", idSede);
