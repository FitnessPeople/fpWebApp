...
namespace fpWebApp
{
    public class clasesglobales
    {
        ...
        public DataTable ConsultarAfiliadoPorIdEncabezado(int idAfiliado)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_AFILIADO_POR_ID_PARA_ENCABEZADO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_afiliado", idAfiliado);
        ...
        public DataTable ConsultaCargarAgenda(int idConsultorio)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        public DataTable ConsultaCargarEntrenadores()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_ENTRENADORES", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultaCargarClasesGrupales()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_CLASES_GRUPALES", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultaCargarSesionesClasesGrupales(int idSede)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_SESIONES_CLASES_GRUPALES", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_sede", idSede);
        ...
        public DataTable ConsultaCargarSesionesPersonalizadas(int idSede)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_SESIONES_PERSONALIZADAS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_sede", idSede);
        ...
        public DataTable ConsultarTokensPorIdVendedor(int idVendedor)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_TOKENS_POR_VENDEDOR", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_vendedor", idVendedor);
        ...
        public DataTable ConsultarCategoriasPaginasPorId(int idCategoria)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CATEGORIAS_PAGINAS_POR_ID", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_categoria_pag", idCategoria);
        ...
        public DataTable ConsultarCategoriaPaginaPorNombre(string nombre_categoria)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CATEGORIA_PAGINA_POR_NOMBRE", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_nombre_categoria_pag", nombre_categoria);
        ...
        public string ActualizarCategoriaPagina(int idCategoriaPagina, string nombreCategoriaPagina, string iconoPagina, string identificador, string Orden)
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ACTUALIZAR_CATEGORIA_PAGINA", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultarNegociaciones()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_NEGOCIACION", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public string EliminarNegociacionCorporativa(int idNegociacion)
        {
            string respuesta = string.Empty;
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ELIMINAR_NEGOCIACION", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_negociacion", idNegociacion);
        ...
        public string ActualizarAsesorPregestionCorporativo(int idPregestion, int idAsesor)
        {
            string respuesta = string.Empty;
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ACTUALIZAR_ASESOR_PREGESTION", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultarClientecorporativo(string documento)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CLIENTE_CORPORATIVO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public (int salida, string mensaje) EliminarAsignacionClienteCorporativo(int idPregestion)
        {
            string strConexion = WebConfigurationManager.ConnectionStrings["ConnectionFP"].ConnectionString;
            ...
            using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
            {
                ...
                using (MySqlCommand cmd = new MySqlCommand("Pa_ELIMINAR_ASIGNACION_CLIENTE_CORPORATIVO", mysqlConexion))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultaAgendaPorAsesor(int idUsuario)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_AGENDA_ASESOR", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_usuario", idUsuario);
        ...
        public DataTable ConsultarEmpresasYProspectosCorporativosPorUsuario(int idUsuario)
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_EMPRESAS_Y_PROSPECTOS_CORPORATIVOS_POR_USUARIO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_usuario", idUsuario);
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
        ...
        public DataTable ConsultarConvevioPorIdEmpresa(int idempresaAfiliada)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("PA_CONSULTAR_CONVENIOS_POR_ID_EMPRESA", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_idEmpresaAfiliada", idempresaAfiliada);
        ...
        public DataTable ConsultarIndicadoresInicioDirComercial()
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_INICIO_DIR_COMERCIAL", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarIndicadoresInicioDirOperativo()
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_INICIO_DIRECTOR_OPERATIVO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarKpisDirOperacionMes(int mes, int annio)
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_KPIS_DIRECCION_OPERACIONES", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("p_mes", mes);
        ...
        public DataTable ConsultarIndicadoresInicioDirComercialConcetracionMetas()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_CONCENTRACION_METAS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarIndicadoresInicioAdminSede(int idCanalVenta)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_CARDS_ADMIN_SEDE", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultarIndicadoresInicioDirMarketing()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_INICIO_DIR_MARKETING", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarIndicadoresInicioDirRRHH()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_DIR_RRHH", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarIndicadoresInicioCoordAsistencial()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_INICIO_COORDINA_ASISTENCIAL", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable consultarIndicadoresInicioPsicologoRH()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_INICIO_PSICOLOGO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarCumpleanosEmpleadosMes(int mes, int annio)
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CUMPLEANOS_EMPLEADO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("p_mes", mes);
                        cmd.Parameters.AddWithValue("p_anio", annio);
        ...
        public DataTable ConsultarIndicadoresLiquidacionesGeneradas()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INDICADORES_LIQUIDACIONES_GENERADAS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarDetalleLiquidacionesPorIdLiq(int idLiq)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_DETALLE_LIQUIDACION_POR_ID", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("p_id_liquidacion", idLiq);
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
                            mysqlConexion.Open();
                            dataAdapter.Fill(dt);
        ...
        public DataTable ConsultarEmpresaAfiliadaPorDocumento(string doc_empresa)
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_EMPRESA_AFILIADA_POR_DOCUMENTO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_doc_empresa", doc_empresa);
        ...
        public DataTable ConsultarUsuariosPlanesPorFecha(DateTime FechaIni, DateTime FechaFin)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_REPORTE_USUARIOS_PLANES_POR_FECHA", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_fecha_ini", FechaIni);
                        cmd.Parameters.AddWithValue("@p_fecha_fin", FechaFin);
        ...
        public DataTable ConsultarRolesYPermisos()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_PERFILES_COMPLETO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultarVentasVsMetasPorFecha(DateTime FechaIni, DateTime FechaFin)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_REPORTE_VENTAS_VS_METAS_ASESOR", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_fecha_ini", FechaIni);
                        cmd.Parameters.AddWithValue("@p_fecha_fin", FechaFin);
        ...
        public DataTable ConsultarEmpleadosActivosInactivos()
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_REPORTE_EMPLEADOS_ACTIVOS_INACTIVOS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public string InsertarPregestionAsesorCRM(string nombre, string apellido, string documento, int idTipoDocumento, string celular,
    int tipoGestion, int idCanalVenta, int idUsuarioAsigna, int asesor, string estado, string DocumentoEmpresa)
        {
            string respuesta = string.Empty;
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INSERTAR_PREGESTION_ASESOR_CRM", mysqlConexion))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@p_id_asesor", asesor);
                        cmd.Parameters.AddWithValue("@p_estado", estado);
                        cmd.Parameters.AddWithValue("@p_doc_empresa", DocumentoEmpresa);
        ...
        public DataTable ConsultarProspectosCRMAsignados2()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_PROSPECTOS_CRM_ASIGNADOS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public DataTable ConsultarProspectosCRMAsignados()
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_PROSPECTOS_ASIGNADOS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
        ...
        public string ActualizarEmpleado( string documentoEmpleado, int tipoDocumento, string nombreEmpleado,
        string telEmpleado, string telEmpleadoCorp, string emailEmpleado, string emailEmpleadoCorp, string dirEmpleado, 
        int idCiudadEmpleado, string fechaNacEmpleado, string fotoEmpleado, string nroContrato, string tipoContrato, int idEmpresaFP, 
        int idSede, string fechaIni, string fechaFin, decimal sueldo, string grupoNomina, int idEps, int idFondo, int idArl, int idCajaCompensa, 
        int idCesantias, string estadoEmpleado, int idGenero, int idEstadoCivil, int idCanalVenta, int idCargo, int idProfesion, string profesion, 
        string nivelEstudio, int estratoSocial, string tipoVivienda, int nroPersonas, string actividadExtra, string consumeLicor, 
        string medioTransporte, string tipoSangre, string placaVehiculo, string tipoRetiro, DateTime? fechaExpedicion,  string nombreContacto, 
        string telContacto, string parentescoContacto,  int idUsuario
)
        {
            string respuesta = string.Empty;
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ACTUALIZAR_EMPLEADO", mysqlConexion))
                    {
                        ...
                        // Placa opcional
                        cmd.Parameters.Add("@p_placa", MySqlDbType.VarChar).Value =
                            string.IsNullOrWhiteSpace(placaVehiculo) ? DBNull.Value : (object)placaVehiculo;

                        cmd.Parameters.AddWithValue("@p_tipo_retiro", tipoRetiro);

                        // Fecha opcional
                        cmd.Parameters.Add("@p_fecha_expedicion", MySqlDbType.Date).Value =
                            fechaExpedicion.HasValue ? (object)fechaExpedicion.Value : DBNull.Value;
        ...
        public DataTable ConsultarHistoriaClinicaPorIdAfiliado(int idAfiliado)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_HISTORIA_CLINICA_POR_ID_AFILIADO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_afiliado", idAfiliado);
        ...
        public DataTable ConsultaConsultorios()
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CONSULTORIOS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable ConsultarConsultorioPorId(int idConsultorio)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CONSULTORIO_POR_ID", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_consultorio", idConsultorio);
        ...
        public DataTable ConsultarConsultorioPorNombrePorSede(string strNombre, int idSede)
        {
            DataTable dt = new DataTable();
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_CONSULTORIO_POR_NOMBRE_POR_SEDE", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_nombre_consultorio", strNombre);
                        cmd.Parameters.AddWithValue("@p_idSede", idSede);
        ...
        public string ActualizarConsultorio(int idConsultorio, int idSede, string nombreConsultorio)
        {
            string respuesta = string.Empty;
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ACTUALIZAR_CONSULTORIO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        ...
                        cmd.Parameters.AddWithValue("@p_id_consultorio", idConsultorio);
                        cmd.Parameters.AddWithValue("@p_id_sede", idSede);
                        cmd.Parameters.AddWithValue("@p_nombre_consultorio", nombreConsultorio);
        ...
        public string EliminarConsultorio(int idConsultorio)
        {
            string respuesta = string.Empty;
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    ...
                    using (MySqlCommand cmd = new MySqlCommand("Pa_ELIMINAR_CONSULTORIO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_consultorio", idConsultorio);
        ...
        public string InsertarConsultorio(int idSede, string nombreConsultorio)
        {
            string respuesta = string.Empty;
            try
            {
                ...
                {
                    mysqlConexion.Open();
                    using (MySqlCommand cmd = new MySqlCommand("Pa_INSERTAR_CONSULTORIO", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_sede", idSede);
                        cmd.Parameters.AddWithValue("@p_nombre_consultorio", nombreConsultorio);
        ...
        public DataTable ValidarConsultorioDisponibilidad(int idConsultorio)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_VALIDAR_CONSULTORIO_DISPONIBILIDAD", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_consultorio", idConsultorio);
        ...
        public DataTable CargarCategoriasPaginaPorPerfil(int idPerfil)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_CATEGORIAS_PAGINA_POR_PERFIL", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable CargarPaginasPorCategoriayPerfil(int idCategoriaPagina, int idPerfil)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_PAGINAS_POR_CATEGORIA_Y_PERFIL", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_categoria_pagina", idCategoriaPagina);
                        cmd.Parameters.AddWithValue("@p_id_perfil", idPerfil);
        ...
        public DataTable ConsultarPagosPorTipoPlanes(int idCanalVenta, int tipoPago, int idPlan, string fechaIni, string fechaFin, out decimal valorTotal)
        {
            DataTable dt = new DataTable();
            valorTotal = 0;
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_PAGOS_POR_TIPO_PLANES", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable CargarSoportesFPMas(int idUsuario)
        {
            DataTable dt = new DataTable();
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CARGAR_SOPORTE_FPMAS", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.AddWithValue("@p_id_usuario", idUsuario);
        ...
        public DataTable ConsultarCobrosRecurrentes()
        {
            ...
            try
            {
                ...
                using (MySqlConnection mysqlConexion = new MySqlConnection(strConexion))
                {
                    using (MySqlCommand cmd = new MySqlCommand("Pa_CONSULTAR_AFILIADOS_PLANES_POR_COBRAR", mysqlConexion))
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        using (MySqlDataAdapter dataAdapter = new MySqlDataAdapter(cmd))
                        {
