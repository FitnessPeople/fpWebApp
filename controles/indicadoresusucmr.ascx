...
<div class="row">
    <div class="col-lg-3">
        <<asp:Literal ID="ltColor4" runat="server" />
            <div class="row">
                ...
                <div class="col-xs-8 text-right">
                    <span>
                        <asp:Literal ID="ltEstado1" runat="server"></asp:Literal>
                    </span>
                    <h2 class="font-bold">
    ...
    <div class="col-lg-3">
        ...
        <<asp:Literal ID="ltColor1" runat="server" />
            <div class="row">
                <div class="col-xs-4">
                ...
                <div class="col-xs-8 text-right">
                    <span>
                        <asp:Literal ID="ltEstado2" runat="server"></asp:Literal>
                    </span>
                    <h2 class="font-bold">
    ...
    <div class="col-lg-3">
     <%--   <div class="widget style1 yellow-bg">--%>
         <<asp:Literal ID="ltColor2" runat="server" />
            <div class="row">
                <div class="col-xs-4">
                ...
                <div class="col-xs-8 text-right">
                    <span>
                        <asp:Literal ID="ltEstado3" runat="server"></asp:Literal>
                    </span>
                    <h2 class="font-bold">
    ...
    <div class="col-lg-3">
        <%--<div class="widget style1 navy-bg">--%>
         <<asp:Literal ID="ltColor3" runat="server" />
            <div class="row">
                <div class="col-xs-4">
                ...
                <div class="col-xs-8 text-right">
                    <span>
                        <asp:Literal ID="ltEstado4" runat="server"></asp:Literal>
                    </span>
                    <h2 class="font-bold">
