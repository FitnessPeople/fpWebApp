<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="correoeliminado.aspx.cs" Inherits="fpWebApp.correoeliminado" %>
...
<head>
    ...
    <title>Fitness People | Correo eliminado</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-trash text-success m-r-sm"></i>Papelera</h2>
                    <ol class="breadcrumb">
                                    ...
                                    <div class="mail-tools tooltip-demo m-t-md">
                                        ...
                                        <button class="btn btn-white btn-sm"><i class="fa fa-arrow-right"></i></button>--%>
                                            <asp:LinkButton ID="btnAnterior" runat="server" CssClass="btn btn-white btn-sm"
                                                OnClick="btnAnterior_Click" data-toggle="tooltip" data-placement="bottom" title="Anterior">
                                                <i class="fa fa-arrow-left"></i>
                                            </asp:LinkButton>
                                            <asp:LinkButton ID="btnSiguiente" runat="server" CssClass="btn btn-white btn-sm"
                                                OnClick="btnSiguiente_Click" data-toggle="tooltip" data-placement="bottom" title="Siguiente">
                                                <i class="fa fa-arrow-right"></i>
                                            </asp:LinkButton>
                                        </div>
                                        <button class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="bottom" title="Refrescar"><i class="fa fa-refresh m-r-xs"></i>Refrescar</button>
                                    </div>
