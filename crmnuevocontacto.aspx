                    ...
                    <form role="form" id="form" runat="server">
                        <div class="row" id="divContenido" runat="server">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div id="acordeonZonaLateralIzqSup" class="acordeon expandido">
...
<%--                                                            <asp:RequiredFieldValidator ID="rfvContactos" runat="server" ErrorMessage="* Campo requerido"
                                                                ControlToValidate="ddlContactos" ValidationGroup="agregarE"
                                                                CssClass="font-bold text-danger" InitialValue="">
                                                            </asp:RequiredFieldValidator>--%>
                                                        </div>
                                                    </div>
