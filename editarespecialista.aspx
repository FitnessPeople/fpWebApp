<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editarespecialista.aspx.cs" Inherits="fpWebApp.editarespecialista" %>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-id-card text-success m-r-sm"></i>Editar especialista</h2>
                    <ol class="breadcrumb">
                        <li>
                ...
                <div class="row animated fadeInDown">
                            ...
                            <div class="ibox float-e-margins" runat="server" id="divContenido">
                                <div class="ibox-title">
                                    <h5>Formulario para la modificación de un especialista</h5>
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="alert alert-danger alert-dismissable" runat="server" id="divMensaje1" visible="false">
                                        ...
                                        No existe el especialista para editar.<br />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txbDocumento" CssClass="form-control input-sm" runat="server"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
