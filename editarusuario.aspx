<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editarusuario.aspx.cs" Inherits="fpWebApp.editarusuario" %>
...
<head>
    ...
    <title>Fitness People | Editar usuario</title>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Guía para editar un usuario</h4>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-user-pen text-success m-r-sm"></i>Editar usuario</h2>
                    <ol class="breadcrumb">
                ...
                <div class="row animated fadeInDown">
                    ...
                    <div class="ibox float-e-margins" runat="server" id="divContenido">
                        <div class="ibox-title">
                            <h5>Formulario para la edicion de un usuario</h5>
                                    ...
                                    <div class="col-sm-6 b-r">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txbNombre" CssClass="form-control" runat="server" placeholder="Nombre(s)"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Clave:</label>
                                                    <asp:TextBox ID="txbClave" CssClass="form-control" runat="server" placeholder="Clave" TextMode="Password"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Perfil:</label>
                                                    <asp:DropDownList ID="ddlPerfiles" runat="server" AppendDataBoundItems="true" DataTextField="Perfil" DataValueField="idPerfil" CssClass="form-control m-b">
                                                        <asp:ListItem Text="Seleccione" Value=""></asp:ListItem>
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
