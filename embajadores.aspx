<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="embajadores.aspx.cs" Inherits="fpWebApp.embajadores" %>
...
<head>
    ...
    <title>Fitness People | Embajadores</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#embajadores");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Guía para visualizar los usuarios inscritos en Embajadores</h4>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-person-rays text-success m-r-sm"></i>Embajadores</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Página Web</li>
                        <li class="active"><strong>Embajadores</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txbNombre" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="rfvSede" runat="server" ErrorMessage="* Campo requerido"
                                                                        ControlToValidate="txbNombre" ValidationGroup="agregar"
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Código:</label>
                                                                    <asp:TextBox ID="txbCodigo" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="rfvDirSede" runat="server" ErrorMessage="* Campo requerido"
                                                                        ControlToValidate="txbCodigo" ValidationGroup="agregar"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:DropDownList ID="ddlTipoDocumento" runat="server" CssClass="form-control input-sm"
                                                                        DataTextField="TipoDocumento" DataValueField="IdTipoDoc" AppendDataBoundItems="true">
                                                                        <asp:ListItem Text="Seleccione" Value=""></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    <asp:RequiredFieldValidator ID="rfvCiudadSede" runat="server" ErrorMessage="* Campo requerido"
                                                                        ControlToValidate="ddlTipoDocumento" ValidationGroup="agregar"
                                                                        CssClass="font-bold text-danger" InitialValue="">
                                                                    </asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txbDocumento" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <label>Celular:</label>
                                                                    <asp:TextBox ID="txbCelular" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="rfvCelular" runat="server" ErrorMessage="* Campo requerido"
                                                                        ControlToValidate="txbCelular" ValidationGroup="agregar"
                                                                        CssClass="font-bold text-danger">
                                                                    </asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <asp:TextBox ID="txbInstagram" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                                    <asp:RequiredFieldValidator ID="rfvInstagram" runat="server" ErrorMessage="* Campo requerido"
                                                                        ControlToValidate="txbInstagram" ValidationGroup="agregar"
                                                                        CssClass="font-bold text-danger" InitialValue="">
                                                                    </asp:RequiredFieldValidator>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <a href="embajadores" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                                                ...
                                                <table class="footable table table-striped" data-paging-size="10" 
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-breakpoints="xs">Instagram</th>
                                                            <th class="text-nowrap" data-breakpoints="xs">Estado</th>
                                                            <th data-sortable="false" data-filterable="false" class="text-right">Acciones</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <asp:Repeater ID="rpEmbajadores" runat="server" OnItemDataBound="rpEmbajadores_ItemDataBound">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    <td><%# Eval("NroDocumentoEmb") %></td>
                                                                    <td><%# Eval("NombreEmb") %></td>
                                                                    <td><i class="fab fa-whatsapp m-r-xs font-bold"></i><a href="https://wa.me/57<%# Eval("CelularEmb") %>" target="_blank"><%# Eval("CelularEmb") %></a></td>
                                                                    <td><%# Eval("CodigoEmb") %></td>
                                                                    <td><i class="fab fa-instagram m-r-xs font-bold"></i><a href="https://www.instagram.com/<%# Eval("InstagramEmb") %>" target="_blank"><%# Eval("InstagramEmb") %></a></td>
                                                                    <td><a runat="server" id="cambiaestado" visible="false"><span class='badge badge-<%# Eval("Status") %>'><%# Eval("EstadoEmb") %></span></a></td>
                                                                    <td>
                                        ...
                                        <div class="row" style="font-size: 12px;" runat="server" id="divBotonesLista">
                                            ...
                                            <div class="col-lg-6 form-horizontal">
                                                <a class="btn btn-success pull-right dim m-l-md" style="font-size: 12px;" 
                                                    href="nuevoembajador" title="Agregar embajador" 
