<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="estadocivil.aspx.cs" Inherits="fpWebApp.estadocivil" %>
...
<head>
    ...
    <title>Fitness People | Estado civil</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#estadocivil");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-people-pulling modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar los estados civiles</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los estados civiles de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-people-pulling" style="color: #0D6EFD;"></i> <b>Estado Civil</b>
                    <br />
                        <br />
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>Configuración</li>
                        <li class="active"><strong>Estado civil</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Nombre de la Estado civil:</label>
                                                    <asp:TextBox ID="txbEstadoCivil" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvEstadoCivil" runat="server" ErrorMessage="* Campo requerido"
                                                        ControlToValidate="txbEstadoCivil" ValidationGroup="agregar"
                                                        CssClass="font-bold text-danger"></asp:RequiredFieldValidator>

                                                </div>
                                                <div class="form-group">
                                                    <a href="estadocivil" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <table class="footable table table-striped" data-paging-size="10"
                                            ...
                                            <tbody>
                                                <asp:Repeater ID="rpEstadoCivil" runat="server" OnItemDataBound="rpEstadoCivil_ItemDataBound">
                                                    <ItemTemplate>
                                                        <tr class="feed-element">
                                                            <td><%# Eval("idEstadoCivil") %></td>
