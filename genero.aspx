        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-children modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar los géneros</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los géneros de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-children" style="color: #0D6EFD;"></i> <b>Género</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-children text-success m-r-sm"></i>Género</h2>
                    <ol class="breadcrumb">
