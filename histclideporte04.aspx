<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="histclideporte04.aspx.cs" Inherits="fpWebApp.histclideporte04" %>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="widget style1 bg-success">
                                                    <div class="row vertical-align">
                                                        <div class="col-xs-3">
                                                            <i class="fa fa-head-side-virus fa-2x"></i>
                                                        </div>
                                                        <div class="col-xs-9 text-right">
                                                            <h3 class="font-bold">Origen de la enfermedad</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label>Origen de la Enfermedad</label>
                                                            <asp:DropDownList ID="ddlOrigenEnfermedad" runat="server" CssClass="form-control input-sm">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txbTratamiento" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
