<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="histclinutricion01.aspx.cs" Inherits="fpWebApp.histclinutricion01" %>
                                                ...
                                                <div class="widget style1 bg-success">
                                                    <div class="row vertical-align">
                                                        ...
                                                        <div class="col-xs-9 text-right">
                                                            <h3 class="font-bold">Historia alimentaria</h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="small">Gastritis</label>
                                                            <asp:RadioButtonList ID="rblGastritis" runat="server" CssClass="i-checks input-sm" RepeatDirection="Horizontal">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="small">Colon</label>
                                                            <asp:RadioButtonList ID="rblColon" runat="server" CssClass="i-checks input-sm" RepeatDirection="Horizontal">
                                                                <asp:ListItem Text="&nbsp;Si" Value="1" style="margin-right: 10px;"></asp:ListItem>
                                                                <asp:ListItem Text="&nbsp;No" Value="0" style="margin-right: 10px;"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            <label class="small">Estreñimiento</label>
                                                            <asp:RadioButtonList ID="rblEstrenimiento" runat="server" CssClass="i-checks input-sm" RepeatDirection="Horizontal">
                                                                <asp:ListItem Text="&nbsp;Si" Value="1" style="margin-right: 10px;"></asp:ListItem>
                                                                <asp:ListItem Text="&nbsp;No" Value="0" style="margin-right: 10px;"></asp:ListItem>
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Apetito</label>
                                                            <asp:TextBox ID="txbApetito" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Masticación</label>
                                                            <asp:TextBox ID="txbMasticacion" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txbHabitoIntestinal" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label>Síntomas gastrointestinales</label>
                                                            <asp:TextBox ID="txbSintGastrointestinales" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:TextBox ID="txbAlimPreferidos" CssClass="form-control input-sm" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
