...
//    let num = input.value.replace(/\D/g, ''); // Eliminar caracteres no numÈricos

//    // Si el n˙mero tiene 10 dÌgitos, es un celular
//    if (num.length === 10) {
//        input.value = num.substring(0, 3) + '-' + num.substring(3, 6) + '-' + num.substring(6, 10);
//    }
//    // Si el n˙mero tiene 7 o m·s dÌgitos, es un telÈfono fijo
...
//    input.value = input.value.replace(/[^a-zA-Z·ÈÌÛ˙¡…Õ”⁄Ò—\s]/g, '');
//}
...
//        input.setCustomValidity('Por favor ingrese un correo electrÛnico v·lido.');
//    } else {
