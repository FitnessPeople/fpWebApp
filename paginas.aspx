<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="paginas.aspx.cs" Inherits="fpWebApp.paginas" %>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" 
                                                        CssClass="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md" OnClick="btnCancelar_Click" formnovalidate />
                                                    <asp:Button ID="btnAgregar" runat="server" Text="Agregar" 
                                                        CssClass="btn btn-sm btn-primary pull-right m-t-n-xs" OnClick="btnAgregar_Click" />
                                                </div>
                                                <br />
                                                <br />
                                                <div class="form-group">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <div class="row" style="font-size: 12px;" runat="server" id="divBotonesLista">
                                            ...
                                            <div class="col-lg-2 form-horizontal">
                                                <a class="btn btn-info pull-right dim m-l-md" style="font-size: 12px;" 
                                                    ...
                                                    href="imprimirpaginas" title="Imprimir"><i class="fa fa-print"></i> IMPRIMIR</a>
                                            </div>
                                        </div>
                                        ...
                                        <table class="footable table" data-page-size="10" data-filter="#filter" data-filter-minimum="3">
                                            <thead>
                                                <tr>
                                                    <th width="30%" data-sort-initial="true">Categoría</th>
