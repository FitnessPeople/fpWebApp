        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-person-circle-question modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar las preguntas ParQ</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar las preguntas ParQ de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-layer-group" style="color: #0D6EFD;"></i> <b>Orden</b>,
                        <i class="fa-solid fa-person-circle-question" style="color: #0D6EFD;"></i> <b>Pregunta ParQ</b> o
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-person-circle-question text-success m-r-sm"></i>Preguntas PARQ</h2>
                    <ol class="breadcrumb">
