<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pension.aspx.cs" Inherits="fpWebApp.pension" %>
...
<head>
    ...
    <title>Fitness People | Fondos de Pensión</title>
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-sack-dollar modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar fondos de pensiones</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los fondos de pensiones de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-sack-dollar" style="color: #0D6EFD;"></i> <b>Fondo de Pensión</b>
                    <br />
                        <br />
                    ...
                    <form role="form" id="form" runat="server">
                        <div class="row" id="divContenido" runat="server">
                            ...
                            <div class="col-lg-8">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Lista de Fondos de Pensión</h5>
                                        <div class="ibox-tools">
                                            <a class="collapse-link">
                                                <i class="fa fa-chevron-up"></i>
                                            </a>
