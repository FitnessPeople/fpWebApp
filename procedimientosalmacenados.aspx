<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="procedimientosalmacenados.aspx.cs" Inherits="fpWebApp.procedimientosalmacenados" %>
...
<head>
    ...
    <title>Fitness People | Procedimientos Almacenados</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#procedimientosalmacenados");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-database text-success m-r-sm"></i>Procedimientos almacenados</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Gestión técnica</li>
                        <li class="active"><strong>Procedimientos almacenados</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                ...
                <div class="row animated fadeInDown">
                            ...
                            <div class="ibox float-e-margins" runat="server" id="divContenido">
                                <div class="ibox-title">
                                    <h5>Lista de procedimientos almacenados</h5>
