<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profesiones.aspx.cs" Inherits="fpWebApp.profesiones" %>
...
<head>
    ...
    <title>Fitness People | Profesiones</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#profesiones");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-briefcase modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para gestionar profesiones</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar las profesiones de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    <p>
                        <b>Paso 1: Crea uno nuevo</b><br />
                        Usa el formulario que está a la <b>izquierda</b> para: 
                        Seleccionar el área a la que pertenece el profesional.<br />
                        Digitar el nombre que quieres registrar.<br />
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-briefcase" style="color: #0D6EFD;"></i> <b>Profesión</b> o
                        <i class="fa-solid fa-user-tie" style="color: #0D6EFD;"></i> <b>Área</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-briefcase text-success m-r-sm"></i>Profesiones</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Configuración</li>
                        <li class="active"><strong>Profesiones</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Área a la que pertenece la profesión:</label>
                                                    <asp:DropDownList ID="ddlAreas" runat="server" CssClass="form-control input-sm">
                                                ...
                                                <div class="form-group">
                                                    <a href="profesiones" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
