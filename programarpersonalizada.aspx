<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programarpersonalizada.aspx.cs" Inherits="fpWebApp.programarpersonalizada" %>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><strong>Programar sesión personalizada</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Programar sesión personalizada</h5>
