<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programarsesion.aspx.cs" Inherits="fpWebApp.programarsesion" %>
...
<head>
    ...
    <title>Fitness People | Programar sesión</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-timeline text-success m-r-sm"></i>Programar sesión</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Coordinación deportiva</li>
                        <li class="active"><strong>Programar sesión</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                    ...
                                    <div class="ibox-content" id="divCrear" runat="server" visible="false">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    <asp:DropDownList CssClass="form-control input-sm required" 
                                                        ID="ddlSedesSesion" runat="server" AppendDataBoundItems="true" 
