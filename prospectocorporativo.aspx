<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="prospectocorporativo.aspx.cs" Inherits="fpWebApp.prospectocorporativo" %>
...
<head>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#prospectocorporativo");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-industry text-success m-r-sm"></i>Prospecto corporativo</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Corporativo</li>
                        <li class="active"><strong>Prospecto corporativo</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
