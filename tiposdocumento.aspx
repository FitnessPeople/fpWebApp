<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tiposdocumento.aspx.cs" Inherits="fpWebApp.tipodocumento" %>
...
<head>
    ...
    <title>Fitness People | Tipos de documento</title>
    ...
    <script>
        function changeClass() {
            var element1 = document.querySelector("#tiposdocumento");
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Guía para visualizar tipos de documento</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los tipos de documento de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-id-card" style="color: #0D6EFD;"></i> <b>Tipo de Documento</b> o
                        <i class="fa-solid fa-id-card-clip" style="color: #0D6EFD;"></i> <b>Siglas</b>
                    <br />
                        <br />
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <%--Inicio Breadcrumb!!!--%>
                <div class="col-sm-10">
                    <h2><i class="fa fa-id-card text-success m-r-sm"></i>Tipos de documento</h2>
                    <ol class="breadcrumb">
                        <li><a href="inicio">Inicio</a></li>
                        <li>Configuración</li>
                        <li class="active"><strong>Tipos de documento</strong></li>
                    </ol>
                </div>
                <div class="col-sm-2">
                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txbTipoDoc" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvTipoDoc" runat="server" ErrorMessage="* Campo requerido"
                                                        ControlToValidate="txbTipoDoc" ValidationGroup="agregar"
                                                        CssClass="font-bold text-danger"></asp:RequiredFieldValidator>
                                                </div>
                                                <div class="form-group">
                                                    <asp:Label ID="lblSiglaDocumento" runat="server" Text="Sigla del tipo de documento:" Font-Bold="true"></asp:Label>
                                                    <asp:TextBox ID="txtSiglaDoc" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="rfvSiglaDoc" runat="server" ErrorMessage="* Campo requerido"
                                                        ControlToValidate ="txtSiglaDoc" ValidationGroup ="agregar"
                                                        CssClass="font-bold text-danger"></asp:RequiredFieldValidator>
                                                    </div>
                                                <div class="form-group">
                                                    <a href="tiposdocumento" class="btn btn-sm btn-danger pull-right m-t-n-xs m-l-md">Cancelar</a>
