        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    ...
                    <i class="fa fa-hospital-user modal-icon" style="color: #1C84C6;"></i>
                    <h4 class="modal-title">Guía para visualizar los tipos de incapacidades</h4>
                    <small class="font-bold">¡Bienvenido! Te explicamos cómo gestionar los tipos de incapacidades de manera clara y eficiente.</small>
                </div>
                <div class="modal-body">
                    ...
                    <br />
                        ...
                        <i class="fa-solid fa-hospital-user" style="color: #0D6EFD;"></i> <b>Tipo de Incapacidad</b>
                    <br />
                        <br />
