<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="traspasosAfil.aspx.cs" Inherits="fpWebApp.traspasosAfil" %>
                            ...
                            <div class="row">
                                <form role="form" id="form" enctype="multipart/form-data" runat="server">
                                    ...
                                    <div class="col-sm-2 b-r">
                                        <p class="text-center"><i class="fa fa-angles-right ico big-icon"></i></p>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="txbAfiliadoDestino" CssClass="form-control input-sm" 
                                                        runat="server" placeholder="Nombre / Cédula / Email / Celular"></asp:TextBox>
                                                    <asp:Button ID="btnAfiliadoDestino" runat="server" Text="" 
                                                        style="display:none;" OnClick="btnAfiliadoDestino_Click" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row" runat="server" id="divAfilDestino" visible="false">
                                            <div class="col-md-12">

                                                <div class="contact-box bg-warning">
                                                    <div class="col-sm-4">
                                                        <div class="text-center">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <address>
                                                            ...
                                                            <i class="fa fa-cake"></i>
                                                            <asp:Literal ID="ltCumpleAfiliadoDestino" runat="server"></asp:Literal>
                                                        </address>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Documento de traspaso</label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <asp:Button ID="btnTraspasar" runat="server" CssClass="btn btn-sm btn-primary m-t-n-xs m-r-md pull-right" 
                                                        Text="Traspasar" OnClick="btnTraspasar_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <%--</ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="txbAfiliadoOrigen" EventName="TextChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="txbAfiliadoDestino" EventName="TextChanged" />
                                        <asp:AsyncPostBackTrigger ControlID="btnTraspasar" EventName="Click" />
                                    </Triggers>
                                </asp:UpdatePanel>--%>
                                </form>
                            </div>
